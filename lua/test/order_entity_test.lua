...
describe("OrderEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ABDO_STORE_TEST_ORDER_ENTID JSON to run live")
      return
    end
...
function order_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ABDO_STORE_TEST_ORDER_ENTID")
