...
(0, node_test_1.describe)('ServiceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AbdoStoreSDK({
    ...
    (0, node_test_1.test)('direct-list-service', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-service', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AbdoStoreSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.ABDO_STORE_APIKEY,
        }));
        let idmap = env['ABDO_STORE_TEST_SERVICE_ENTID'];
    ...
    const client = new __1.AbdoStoreSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ServiceDirect.test.js.map