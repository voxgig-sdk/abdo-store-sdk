...
(0, node_test_1.describe)('AccountEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set ABDO_STORE_TEST_ACCOUNT_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['ABDO_STORE_TEST_ACCOUNT_ENTID'];
    ...
    idmap = env['ABDO_STORE_TEST_ACCOUNT_ENTID'];
