...
function envOverride(m) {
    if ('TRUE' === process.env.ABDO_STORE_TEST_LIVE ||
        'TRUE' === process.env.ABDO_STORE_TEST_OVERRIDE) {
    ...
    m.ABDO_STORE_TEST_EXPLAIN = process.env.ABDO_STORE_TEST_EXPLAIN || m.ABDO_STORE_TEST_EXPLAIN;
    return m;
}
