...
func (sdk *AbdoStoreSDK) OptionsMap() map[string]any {
...
func (sdk *AbdoStoreSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AbdoStoreSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AbdoStoreSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AbdoStoreSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AbdoStoreSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AbdoStoreSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AbdoStoreSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AbdoStoreSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AbdoStoreSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AbdoStoreSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
