...
const testSeed = `map[string]any{"entity": map[string]any{"account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "order": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "service": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
