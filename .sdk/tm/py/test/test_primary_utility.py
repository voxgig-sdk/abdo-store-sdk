...
from projectname_sdk import AbdoStoreSDK
from projectname_sdk.core.spec import AbdoStoreSpec
from projectname_sdk.core.result import AbdoStoreResult
from projectname_sdk.core.response import AbdoStoreResponse
from projectname_sdk.core.operation import AbdoStoreOperation
from projectname_sdk.core.error import AbdoStoreError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import AbdoStoreBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return AbdoStoreError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = AbdoStoreSDK.test(None, None)
        ...
        class TestInitFeature(AbdoStoreBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(AbdoStoreBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = AbdoStoreSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = AbdoStoreSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = AbdoStoreSDK.test(None, setup_opts)
