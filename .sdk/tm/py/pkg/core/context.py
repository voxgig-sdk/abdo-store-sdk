...
from projectname_sdk.core.control import AbdoStoreControl
...
class AbdoStoreContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, AbdoStoreSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AbdoStoreResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AbdoStoreResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AbdoStoreError(code, msg, self)
