...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = AbdoStoreOmni.make_runner(TEST_JSON_FILE, AbdoStoreSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : AbdoStoreOmni.errify(err)
    end
