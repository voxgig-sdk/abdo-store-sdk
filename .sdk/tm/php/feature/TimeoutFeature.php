...
class AbdoStoreTimeoutFeature extends AbdoStoreBaseFeature
{
    ...
    private function _with_timeout(AbdoStoreContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AbdoStoreContext $_ctx, float $ms): void
    {
        $client = $this->client;
