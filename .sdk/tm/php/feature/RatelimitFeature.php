...
// AbdoStore SDK ratelimit feature
...
class AbdoStoreRatelimitFeature extends AbdoStoreBaseFeature
{
    ...
    private function _acquire(AbdoStoreContext $ctx): void
    {
    ...
    private function _track(AbdoStoreContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
