...
// AbdoStore SDK clienttrack feature
...
class AbdoStoreClienttrackFeature extends AbdoStoreBaseFeature
{
    ...
    public function PostConstruct(AbdoStoreContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AbdoStore-SDK';
