...
class AbdoStoreCacheFeature extends AbdoStoreBaseFeature
{
    ...
    private function _through(AbdoStoreContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
