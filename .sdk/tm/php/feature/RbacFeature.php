...
class AbdoStoreRbacFeature extends AbdoStoreBaseFeature
{
    ...
    private function _required(AbdoStoreContext $ctx): ?string
    {
    ...
    private function _reject(AbdoStoreContext $ctx, string $required): void
    {
    ...
    private function _track(AbdoStoreContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
