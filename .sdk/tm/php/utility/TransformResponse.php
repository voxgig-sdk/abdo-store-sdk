...
// AbdoStore SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class AbdoStoreTransformResponse
{
    public static function call(AbdoStoreContext $ctx): mixed
    {
        ...
        $transform = AbdoStoreHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
