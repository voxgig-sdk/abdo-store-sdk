...
class AbdoStoreGraphql
{
    ...
    // equivalent.
    public static function body(AbdoStoreContext $ctx): mixed
    {
    ...
    public static function errors(AbdoStoreContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
