...
|---|---|---|
| `ts/` | @voxgig-sdk/abdo-store-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/abdo-store-sdk \
      --repository voxgig-sdk/abdo-store-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/abdo-store-sdk` shows it, and
`npm trust revoke @voxgig-sdk/abdo-store-sdk --id=<id>` removes it.
