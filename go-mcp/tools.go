...
type Args struct {
	Entity string         `json:"entity" jsonschema:"account | order | service"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AbdoStoreSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "abdo-store_list",
		Description: "List records from AbdoStore. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "abdo-store_load",
		Description: "Load a single record from AbdoStore. " +
...
func runOp(client *sdk.AbdoStoreSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AbdoStoreSDK, name string) (sdk.AbdoStoreEntity, error) {
