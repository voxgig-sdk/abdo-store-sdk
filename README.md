...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/abdo-store` | `npm install @voxgig-sdk/abdo-store` |
| Python | `voxgig-sdk-abdo-store` | `pip install voxgig-sdk-abdo-store` |
| PHP | `voxgig-sdk/abdo-store` | `composer require voxgig-sdk/abdo-store` |
| Golang | `github.com/voxgig-sdk/abdo-store-sdk/go` | `go get github.com/voxgig-sdk/abdo-store-sdk/go` |
| Ruby | `voxgig-sdk-abdo-store` | `gem install voxgig-sdk-abdo-store` |
| Lua | `voxgig-sdk-abdo-store` | `luarocks install voxgig-sdk-abdo-store` |
