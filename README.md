...
Abdo Store API offers a range of social media marketing services, providing users with access to tools for enhancing their online presence.

Learn more about Abdo Store API at [abdoastore.store](https://abdoastore.store).

This is an unofficial SDK for the Abdo Store public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Account, Order and Service — that you
...
| Ruby | `voxgig-sdk-abdo-store` | publish pending — [install from git tag](https://github.com/voxgig-sdk/abdo-store-sdk/releases) |
| Lua | `voxgig-sdk-abdo-store` | publish pending — [install from git tag](https://github.com/voxgig-sdk/abdo-store-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/abdo-store-sdk/go-cli` | `go install github.com/voxgig-sdk/abdo-store-sdk/go-cli/cmd/abdo-store@latest` |
| Go MCP server | `github.com/voxgig-sdk/abdo-store-sdk/go-mcp` | `go get github.com/voxgig-sdk/abdo-store-sdk/go-mcp@latest` |
