...
class OrderEntity
  ...
  # @return [Order, Hash] the loaded Order; raises AbdoStoreError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Order, Hash] the created Order; raises AbdoStoreError on failure
