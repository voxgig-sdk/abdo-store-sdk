...
The PHP SDK for the AbdoStore API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Account(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->AbdoStore(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── abdostore_sdk.php          -- Main SDK class
...
The main class (`abdostore_sdk.php`) exports the SDK class
