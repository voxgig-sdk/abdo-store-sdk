...
class AccountEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ABDOSTORE_TEST_ACCOUNT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function account_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ABDOSTORE_TEST_ACCOUNT_ENTID");
