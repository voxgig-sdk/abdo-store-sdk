...
// AbdoStore SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AbdoStoreSDK::test)
...
{
    private const SDK_CLASS = 'AbdoStoreSDK';
    ...
    private const SDK_BASE = 'abdostore_sdk';
