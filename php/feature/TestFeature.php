...
// AbdoStore SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AbdoStoreTestFeature extends AbdoStoreBaseFeature
{
    ...
    public function init(AbdoStoreContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AbdoStoreContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = AbdoStoreParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AbdoStoreContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AbdoStoreContext $ctx, $op, $args): array
    {
