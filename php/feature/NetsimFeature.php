...
class AbdoStoreNetsimFeature extends AbdoStoreBaseFeature
{
    ...
    private function _simulate(AbdoStoreContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AbdoStoreContext $ctx, array $applied): void
    {
        $client = $this->client;
