...
// AbdoStore SDK streaming feature
...
class AbdoStoreStreamingFeature extends AbdoStoreBaseFeature
{
    ...
    private function _iterate(AbdoStoreResult $result): \Generator
    {
    ...
    private function _streamable(AbdoStoreContext $ctx): bool
    {
