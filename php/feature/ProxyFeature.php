...
class AbdoStoreProxyFeature extends AbdoStoreBaseFeature
{
    ...
    public function init(AbdoStoreContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AbdoStoreContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
