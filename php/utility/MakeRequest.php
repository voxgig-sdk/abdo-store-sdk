...
// AbdoStore SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AbdoStoreMakeRequest
{
    public static function call(AbdoStoreContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AbdoStoreResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AbdoStoreResponse($fetched);
        } else {
