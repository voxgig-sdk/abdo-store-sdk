...
// AbdoStore SDK utility: fetcher

class AbdoStoreFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AbdoStoreSDK/1.0)';
    ...
    public static function call(AbdoStoreContext $ctx, string $fullurl, array $fetchdef): array
    {
