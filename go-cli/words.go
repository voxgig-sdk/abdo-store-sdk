...
func registerSDKWords(r *eng.Registry, client *sdk.AbdoStoreSDK) {
...
func runOp(client *sdk.AbdoStoreSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
