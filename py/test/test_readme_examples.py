# AbdoStore SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AbdoStoreSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AbdoStoreSDK(...) and AbdoStoreSDK.test(...) become
#      AbdoStoreSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "abdostore_sdk"
_SDK_CLASS = "AbdoStoreSDK"
