...
class AbdoStoreTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AbdoStoreTestRunner.getenv("ABDOSTORE_TEST_LIVE")
        override = AbdoStoreTestRunner.getenv("ABDOSTORE_TEST_OVERRIDE")
        ...
        explain = AbdoStoreTestRunner.getenv("ABDOSTORE_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["ABDOSTORE_TEST_EXPLAIN"] = explain
